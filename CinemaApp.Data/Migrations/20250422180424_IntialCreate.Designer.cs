...
namespace CinemaApp.Data.Migrations
{
    ...
    [Migration("20250422180424_IntialCreate")]
            ...
            modelBuilder.Entity("CinemaApp.Data.Models.Cinema", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1b135878-3362-41f8-b0f4-6784008d24b6"),
                            IsDeleted = false,
                            Location = "Sofia",
                            Name = "Cinema city"
                        },
                        new
                        {
                            Id = new Guid("6541d72b-eae2-4b8e-930a-1c3f8a8aaf38"),
                            IsDeleted = false,
                            Location = "Plovdiv",
                            Name = "Cinema city"
                        },
                        new
                        {
                            Id = new Guid("4664cc25-7285-4172-b5eb-c22dd2b5c4e5"),
                            IsDeleted = false,
                            Location = "Varna",
                            Name = "Cinemax"
                        });
